            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">
                  Discover how Talking, Done Simply is helping people boost their productivity and creativity.
                </p>
              </div>
        ...
        <footer className="bg-gray-100 dark:bg-gray-900 py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4 max-w-md">
                  Experience the power of conversational AI with Talking, Done Simply. Get instant answers, creative content, and intelligent assistance.
                </p>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
              <p>© {new Date().getFullYear()} Talking, Done Simply. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
